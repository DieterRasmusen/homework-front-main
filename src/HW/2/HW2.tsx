...
export const HW2 = () => {
  ...
  const users: UsersObjectType = {
    myFriends: [{id: 1, name: 'John', age: 25, address: {street: '123 Main St', city: 'New York'}},
  ...
  const filterUsers = () => {
    const filteredUsers = users.myFriends.filter((user) => user.address.city  === "Los Angeles"); /*'НУЖНО' +
